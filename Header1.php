<table width="1336" cellpadding="0" cellspacing="0">
  <tr>
    <td width="1292" height="50" align="right" bgcolor="#4691D5"><font color="#FFFFFF" size="4">Welcome</font><?php
         if(isset($_SESSION["n"]))
		 	{
				print '<font color="#FFFFFF" size="4">&nbsp;';
				print  $_SESSION["n"];
				print "</font>";
				print "  <a href='changepass.php'><font color='#FFFFFF' size='4'>&nbsp;Change Password</font></a>";
				print "  <a href='logout.php'><font color='#FFFFFF' size='4'>&nbsp;Logout</font></a>";
			}
		else
		{
			print "<font color='#FFFFFF' size='4'>&nbsp;Guest</font>";
				print "  <a href='login.php'><font color='#FFFFFF' size='4'>&nbsp;Login</font></a>";
				print "  <a href='signup.php'><font color='#FFFFFF' size='4'>&nbsp;Signup</font></a>";
			}
