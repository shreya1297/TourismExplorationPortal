...
function xyz()
{
	...
	{
		alert("please fill your proper State Name");
		return false;
	}
...
<table width="1336" border="0">
  ...
  <tr>
    <td><form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return xyz()">
      <table width="1336" border="0">
        <tr>
          <td align="center"><h2>Add State</h2></td>
        </tr>
      </table>
      ...
      <table width="1336" border="0" cellpadding="5">
        <tr>
          ...
          <td width="989"><label for="catname"></label>
            <input type="text" name="catname" id="catname"  onkeypress="return isNumberKey(event)"/></td>
        </tr>
        <tr>
          <td>State Picture</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><input type="submit" name="sub" id="sub" value="Add State" />
