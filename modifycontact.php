...
<table width="1336" border="0">
  ...
  <tr>
    <td><table width="1336" border="0">
        <tr>
          <td height="83" align="center"><h2><font color="#FF3366">Messages</font></h2></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="left"><?php
            ...
            $q="select * from contactus order by Date desc";
						...
						while($x=mysqli_fetch_array($res))
						{
							if(($c%2)==0) 
							{
								print "<tr bgcolor=' #ccddff'>
										...
										<td>$x[Username]</td>
										<td>$x[Message]</td>
										<td><a href='deletecontact.php?uid=$x[Date]'>Delete</a></td>
